...
description: "A collection of references, tutorials, and links for scientific computing using Python."
date: 2026-07-06 00:00:00 +0530
categories: [Programming, Python]
tags: [python, computational-physics, numerical-methods]
math: true
---

## Introductory Books

- [Think Python, Allen B. Downey (Third Ed., O’Reilly, 2024)](https://greenteapress.com/wp/think-python-2e/)
...
- [Learning Scientific Programming with Python, Christian Hill (Second Ed., CUP, 2020)](https://scipython.com/books/book2/)
- [Mathematical Python, Patrick Walls, University of British Columbia](https://patrickwalls.github.io/mathematicalpython/)
- [Python Programming and Numerical Methods: A Guide for Engineers and Scientists, Qingkai Kong, Timmy Siauw, Alexandre M. Bayen (Academic Press, 2021)](https://pythonnumericalmethods.berkeley.edu/notebooks/Index.html)

## Advanced Scientific Computing

- [Numerical Methods in Physics with Python, Alex Gezerlis (Second Ed., CUP, 2023)](https://numphyspy.org/)
